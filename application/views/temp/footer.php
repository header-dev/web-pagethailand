    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015 <a href="#">Header-Dev</a>.</strong> All rights reserved.
    </footer>
    ...
    <!-- <script src="<?php echo THEME; ?>plugins/morris/morris.min.js"></script> -->
    <!-- Sparkline -->
    ...
    <script src="<?php echo JS; ?>bootstrapValidator.min.js"></script>
</body>
</html>