 ...
 <div class="content-wrapper">
        ...
        <input type="hidden" value="<?php echo $data[0]['member_id']; ?>" name="" value="">
        <fieldset>
        <div class="form-group">
            <label for="name"  class="col-lg-3 control-label"><?php echo label("name"); ?> : </label>
            <div class="col-lg-6">
            <input type="text" name="name" id="name" value="<?php echo $data[0]['name']; ?>" required="true" class="form-control" placeholder="<?php echo label("name"); ?>"/>
            </div>
        </div>
        <div class="form-group">
            <label for="description"  class="col-lg-3 control-label">User Name : </label>
            <div class="col-lg-6">
            <input type="text" name="username" value="<?php echo $data[0]['username']; ?>" id="username" required="true" class="form-control" placeholder="<?php echo label("username"); ?>"/>
            </div>
        </div>
        <div class="form-group">
