...
<div class="content-wrapper">
      ...
      <section class="content">
        <div class="row">
        <form id="frmNews" action="<?php echo base_url(); ?>news/saveupdatenews" onsubmit="return checkSize(2097152)" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="news_id" value="<?php echo $data[0]['news_id']; ?>">
        <div class="box box-warning">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="text" required class="form-control" value="<?php echo $data[0]['topic']['english']; ?>" name="topic[english] value=''">
              </div>
            </div>
            <br>
            <br>
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="text" class="form-control" value="<?php echo $data[0]['sub-topic']['english'] ?>" name="sub-topic[english] value=''">
              </div>
            </div>
            <br>
            <br>
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="text" required class="form-control" value="<?php echo $data[0]['topic']['chinese']; ?>" name="topic[chinese] value=''">
              </div>
            </div>
            <br>
            <br>
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="text" class="form-control" value="<?php echo $data[0]['sub-topic']['chinese'] ?>" name="sub-topic[chinese] value=''">
              </div>
            </div>
            <br>
            <br>
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="text" required class="form-control" value="<?php echo $data[0]['topic']['japanese']; ?>" name="topic[japanese] value=''">
              </div>
            </div>
            <br>
            <br>
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="text" class="form-control" value="<?php echo $data[0]['sub-topic']['japanese'] ?>" name="sub-topic[japanese] value=''">
              </div>
            </div>
            <br>
            <br>
            <div class="form-group">
              ...
              <div class="col-lg-4">
                <input type="text" readonly value="<?php echo $data[0]['news_date']; ?>" class="form-control" name="news_date" id="news_date">
              </div>
            </div>
            <br><br>
        <div class="form-group">
        ...
        <div class="col-lg-4">
            <?php if(!empty($data[0]['thumbnail'])): ?>
            <div class="pre-img">
                <img src="<?php echo IMG; ?>news/thumbnail/<?php echo $data[0]['thumbnail']; ?>"  alt="" height="200" width="250">
            </div>
            <br>
            ...
            <?php else: ?>
            <input type="file" name="thumbnail" accept=".jpg,.jpeg" class="form-control" id="thumbnail" >
            <?php endif; ?>
        </div >
        </div>
          </div><!-- /.box-body -->
