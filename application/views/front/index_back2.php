    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header text-success">
                    <i class="fa fa-briefcase"></i> <?php echo label("service"); ?>
                </h3>
            </div>
        ...
        <div class="row">
            ...
            <?php if(!empty($news)): ?>
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-md-8">
                        <h4 class="text-success"><?php echo $new['topic'][$this->session->userdata('lang')] ?></h4>
                        <p><?php echo $new['sub-topic'][$this->session->userdata('lang')] ?>  <button class="btn btn-xs btn-success" onclick="readmore(<?php echo $new['news_id']; ?>);">read more</button></p>
                    </div>
                </div>
                <?php endforeach; ?>
            <?php endif; ?>
