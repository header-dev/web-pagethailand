      ...
      <div class="col-md-12">
        <div class="box box-solid">
          <div class="box-header with-border">
            ...
            <h3 class="box-title"><?php echo $data[0]['service'][$this->session->userdata("lang")]; ?></h3>
          </div><!-- /.box-header -->
          <div class="box-body">
            <dl class="dl-horizontal">
              <dt><?php echo label("service"); ?></dt>
              <dd>
              <span class="label label-info"><?php echo $data[0]['service'][$this->session->userdata("lang")]; ?></span></dd>
              <br>
              <dt><?php echo label("label-detail"); ?></dt>
              <dd><?php echo $data[0]['service_detail'][$this->session->userdata("lang")]; ?></dd>
              <br>
              ...
              <dd>
              <a id="preview" href="<?php echo IMG; ?>service/thumbnail/<?php echo $data[0]['thumbnail']; ?>">
                <img src="<?php echo IMG; ?>service/thumbnail/<?php echo $data[0]['thumbnail']; ?>" class="img-responsive" alt="Image" height="300" width="300">
              </a>
              </dd>
            </dl>
          </div><!-- /.box-body -->
