      ...
      <div class="col-md-12">
        <div class="box box-solid">
          <div class="box-header with-border">
            ...
            <h3 class="box-title">Picture Form : <?php echo $service; ?></h3>
          </div><!-- /.box-header -->
          <div class="box-body">
...
<script type="text/javascript">
  $(function() {
    ...
    $("#upload").uploadify({
          ...
          // 'fileSizeLimit' : '400KB',
          uploader:"<?php echo base_url(); ?>services/do_upload?service_id=<?php echo $service_id; ?>",
  ...
  function getallpicture(){
    $('#showimage').load('<?php echo base_url(); ?>services/getpictureservice?service_id=<?php echo $service_id; ?>');
  }

  function removeImage(id){
    $.ajax({
      url: '<?php echo base_url() ?>services/deleteimg',
      type: 'POST',
      data: {image_id: id},
