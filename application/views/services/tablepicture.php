  ...
  <thead>
        ...
        <tbody>
          ...
          <?php foreach ($data as $r) :?>
            <tr>
              <td width="15%">
                <img src="<?php echo IMG; ?>service/<?php echo $r['image']; ?>"  alt="" height="100" width="100">
              </td>
              <td>
                <input  type="url" style="width:600px;" class="form-control" name="" value="http://www.sf-engineer.com<?php echo IMG; ?>service/<?php echo $r['image']; ?>" readonly="true" placeholder="">
              </td>
              <td width="10%">
