 ...
 <div class="content-wrapper">
        ...
        action="<?php echo base_url(); ?>information/saveabout" class="form-horizontal"
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8">
            <textarea name="about[thai] value=''" rows="10" required="true" class="form-control" placeholder="เกี่ยวกับเรา"></textarea>
            </div>
        </div>
    <legend>
        <div class="widget-user-image">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8">
            <textarea name="about[english] value=''" rows="10" required="true" class="form-control" placeholder="About Us"></textarea>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <input type="file" required="true" name="thumbnail" accept=".png,.jpg,.jpeg" class="form-control" id="thumbnail" >
        </div >
        </div>
        <legend></legend>
        <div class="form-group">
