 ...
 <div class="content-wrapper">
        ...
        <?php endif; ?>
        <form id="frmProductGroup" name="frmServiceGroup" method="POST" onsubmit="return checkSize(2097152)"
        action="<?php echo base_url(); ?>servicesgroup/saveServiceGroup" class="form-horizontal"
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8">
            <input type="text" name="service_group[thai] value=''" id="service_group" required="true" class="form-control" placeholder="ชื่อกลุ่มบริการ"/>
            </div>
        </div>
        <div class="form-group">
    ...
    <legend>
        ...
        <div class="form-group">
            <label for="name"  class="col-lg-3 control-label">Service Group Name : </label>
            <div class="col-lg-8">
            <input type="text" name="service_group[english] value=''" id="service_group" required="true" class="form-control" placeholder="Service Group Name"/>
            </div>
        </div>
        <div class="form-group">
