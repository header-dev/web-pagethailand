...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Show Service Group</li>
    </ol>
  </section>
    <!-- Main content -->
      ...
      <div class="col-md-12">
        <div class="box box-solid">
          <div class="box-header with-border">
            ...
            <h3 class="box-title"><?php echo $data[0]['service_group'][$this->session->userdata("lang")]; ?></h3>
          </div><!-- /.box-header -->
          <div class="box-body">
            <dl class="dl-horizontal">
              ...
              <dd>
              <a id="preview" href="<?php echo IMG; ?>services_group/thumbnail/<?php echo $data[0]['thumbnail']; ?>">
                <img src="<?php echo IMG; ?>services_group/thumbnail/<?php echo $data[0]['thumbnail']; ?>" class="img-responsive" alt="Image" height="300" width="300">
              </a>
              </dd>
            </dl>
          </div><!-- /.box-body -->
