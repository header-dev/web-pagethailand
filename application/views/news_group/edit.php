 ...
 <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url(); ?>productsgroup"><i class="fa fa-dashboard"></i> News Group</a></li>
        ...
        action="<?php echo base_url(); ?>newsgroup/updateNewsGroup" class="form-horizontal"
        role="form" enctype="multipart/form-data">
        <input type="hidden" name="news_group_id" value="<?php echo $data[0]['news_group_id']; ?>">
        <fieldset>
        <div class="form-group">
            <label for="name"  class="col-lg-3 control-label">Group Name (English): </label>
            <div class="col-lg-8">
            <input type="text" name="news_group[english] value=''" value="<?php echo $data[0]['news_group']['english']; ?>" id="name" required="true" class="form-control" placeholder="Group Name"/>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="col-lg-4">
            <div class="pre-img">
                <img src="<?php echo IMG; ?>news_group/thumbnail/<?php echo $data[0]['thumbnail']; ?>"  alt="" height="100" width="100">
            </div>
