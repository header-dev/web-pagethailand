...
<div class="content-wrapper">
	...
	<form id="frmPackage" name="frmPackage" method="POST"
        action="<?php echo base_url(); ?>package/addpackage" class="form-horizontal"
        role="form">
        <fieldset>
            ...
            <div class="col-lg-4">
                <select name="lang" id="lang" class="form-control" required="required">
                    ...
                    <?php foreach ($lang as $l) : ?>
                        <option value="<?php echo strtolower($l['name']); ?>"><?php echo $l["name"]; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8">
            <textarea cols="70" required="true"  rows="5" name="detail" id="detail" class="form-control"></textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="period_detail"  class="col-lg-3 control-label">Period Detail: </label>
            <div class="col-lg-8">
            <textarea cols="70" required="true"  rows="5" name="period_detail" id="period_detail" class="form-control"></textarea>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8">
            <textarea cols="70" required="true"  rows="5" name="remark" id="remark" class="form-control"></textarea>
            </div>
        </div>
        <legend></legend>
        <div class="form-group">
      <div class="col-lg-6 col-lg-offset-3">
        <button type="submit" class="btn btn-primary"><span class="fa fa-save"></span> Add Package</button>
