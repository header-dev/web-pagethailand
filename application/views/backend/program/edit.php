...
<div class="content-wrapper">
        ...
        action="<?php echo base_url(); ?>program/update" class="form-horizontal"
        role="form">
        <fieldset>
            ...
            <div class="col-lg-4">
                <select name="lang" id="lang" class="form-control" required="required">
                    ...
                    <?php foreach ($lang as $l) : ?>
                        <option value="<?php echo strtolower($l['name']); ?>"
                            <?php if(strtolower($l['name']) == strtolower($program[0]['lang'])){
                                echo "selected";
                            } ?>
        ...
        <input type="hidden" name="program_id" value="<?php echo $program[0]['program_id']; ?>">
        <div class="form-group">
            <label for="name"  class="col-lg-3 control-label">Name : </label>
            <div class="col-lg-8">
            <input type="text" name="name" id="name" value="<?php echo $program[0]['name']; ?>" class="form-control" />
            </div>
        </div>
        <div class="form-group">
            <label for="description"  class="col-lg-3 control-label">Description : </label>
            <div class="col-lg-8">
            <textarea cols="70" required="true"  rows="5" name="description" id="description" class="form-control"><?php echo $program[0]['description']; ?></textarea>
            </div>
        </div>
        <div class="form-group">
        <label for="thumbnail"  class="col-lg-3 control-label">Thumbnail : </label>
        <div class="col-lg-6">
            <input type="text" name="thumbnail" class="form-control img-clouddrive" id="thumbnail" value="<?php echo $program[0]['thumbnail']; ?>" >
            <div class="img-clouddrive-view">
                <img src="<?php echo $program[0]['thumbnail']; ?>" width = "500" height="450" class="img-responsive" alt="Responsive image">
            </div>
        </div >
        </div>
        <legend></legend>
